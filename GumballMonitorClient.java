		...
		try (
			...
			while(stdIn.hasNextLine()) {
				...
				case "report":
					...
					out.println("getCount");
					out.println("getState");
					System.out.println("Gumball Machine: " + inStr.readLine());
					System.out.println("Current inventory: " + inData.readInt() + " gumballs");
					System.out.println("Current State: " + (State)inObj.readObject());
					break;
